                ...
                <div className="nav-container">
                    <ul className="nav-links">
                        <li className={activeTab === 'dashboard' ? 'nav-item active' : 'nav-item'}>
                            <a href="#" onClick={() => setActiveTab('dashboard')} className="nav-link">
                        ...
                        <li className={activeTab === 'profile' ? 'nav-item active' : 'nav-item'}>
                            <a href="#" onClick={() => setActiveTab('profile')} className="nav-link">
                                <svg xmlns="http://www.w3.org/2000/svg" className="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <li className={activeTab === 'skills' ? 'nav-item active' : 'nav-item'}>
                            <a href="#" onClick={() => setActiveTab('skills')} className="nav-link">
                                <svg xmlns="http://www.w3.org/2000/svg" className="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <li className={activeTab === 'learning' ? 'nav-item active' : 'nav-item'}>
                            <a href="#" onClick={() => setActiveTab('learning')} className="nav-link">
                                <svg xmlns="http://www.w3.org/2000/svg" className="nav-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="dashboard-container">
                        ...
                        <div className="full-profile">
                            <div className="profile-info-extended">
                                ...
                                <p className="profile-detail">
                                    ...
                                    <span className="value">April 2025</span>
                                </p>
                            </div>
                            <button className="edit-profile-button">
                                <svg xmlns="http://www.w3.org/2000/svg" className="button-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    {activeTab === 'skills' && (
                        <div className="skills-content">
                            <p className="no-skills-message">You haven't added any skills yet.</p>
                            <button className="add-skills-button">
                                <svg xmlns="http://www.w3.org/2000/svg" className="button-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                                </svg>
                    ...
                    {activeTab === 'learning' && (
                        <div className="learning-content">
                            <p className="learning-message">Discover skills from other community members.</p>
                            <div className="search-box">
                                <input type="text" placeholder="Search for skills..." className="search-input" />
